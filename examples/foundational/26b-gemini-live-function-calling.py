...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments):
    ...
    # You provide the system instructions and tools in the context rather than
    # as arguments to GeminiLiveLLMService, but note that doing so will trigger
    # a (fast) reconnection when the GeminiLiveLLMService first receives the
    # context (i.e. when we send the LLMRunFrame below).
    context = LLMContext(
        [
