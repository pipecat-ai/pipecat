...
from pipecat.services.gemini_multimodal_live.gemini_vertex import (
    GeminiMultimodalLiveVertexLLMService,
)
...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments):
    ...
    llm = GeminiMultimodalLiveVertexLLMService(
        credentials=os.getenv("GOOGLE_TEST_CREDENTIALS"),
        params=GeminiMultimodalLiveVertexLLMService.VertexInputParams(
    ...
    llm.set_model_modalities(GeminiMultimodalModalities.AUDIO)
