...
async def run_example(transport: BaseTransport, _: argparse.Namespace, handle_sigint: bool):
    ...
    messages = [
        {
            "role": "system",
            "content": "You are a helpful AI assistant powered by CambAI's text-to-speech technology. Your goal is to demonstrate natural conversation capabilities in a succinct way. Your output will be converted to audio so don't include special characters in your answers. Respond to what the user said in a creative and helpful way. Keep your responses conversational and engaging.",
        },
    ]
    ...
    async def on_client_connected(transport, client):
        ...
        messages.append({
            "role": "system", 
            "content": "Please introduce yourself to the user as a CambAI-powered assistant and ask how you can help them today."
        })
