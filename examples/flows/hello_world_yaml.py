...
runtime configuration: hello_world.yaml holds the two nodes and the transition
between them, and hello_world_tools.py holds the one tool the flow calls.
...
Run the example:
uv run hello_world_yaml.py
"""

import os
from pathlib import Path

import hello_world_tools
...
FLOW_CONFIG_PATH = Path(__file__).with_name("hello_world.yaml")
...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments):
    ...
    flow = Flow(config, tools=hello_world_tools)
