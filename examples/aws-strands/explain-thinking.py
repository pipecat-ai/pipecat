...
async def run_example(transport: BaseTransport, _: argparse.Namespace, handle_sigint: bool):
    ...
    strands_agent = Agent(
        ...
        """,
        # system_prompt="Explain each step of your reasoning clearly. Your responses will be converted to audio, so avoid special characters (and numbered lists) and keep your answers concise.",
