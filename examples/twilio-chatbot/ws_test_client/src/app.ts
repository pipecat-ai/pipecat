...
class WebsocketClientApp {
  ...
  private async emulateTwilioMessages() {
    ...
    const websocketTransport = this.rtviClient?.transport as PipecatWebsocketTransport
    void websocketTransport?.sendTextMessage(JSON.stringify(connectedMessage))

    const startMessage={"event": "start", "start": {"streamSid": WebsocketClientApp.STREAM_SID, "callSid": WebsocketClientApp.CALL_SID}}
    void websocketTransport?.sendTextMessage(JSON.stringify(startMessage))
  }
