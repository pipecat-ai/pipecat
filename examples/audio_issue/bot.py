...
async def run_bot(room_url: str, token: str, call_id: str, sip_uri: str) -> None:
    ...
    async def on_first_participant_joined(transport, participant):
        ...
        await transport.start_recording(stream_id=stream_id)
    ...
    async def on_participant_left(transport, participant, reason):
        ...
        await transport.stop_recording(stream_id=stream_id)
        await task.cancel()
...
async def main():
    ...
    parser.add_argument("-i", type=str, help="Twilio call ID", default="default_call_id")
    parser.add_argument("-s", type=str, help="Daily SIP URI", default="default_sip_uri")
