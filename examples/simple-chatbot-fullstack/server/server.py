...
async def lifespan(app: FastAPI):
    ...
    - Initializes Daily.co API helper
...
async def create_room_and_token() -> tuple[str, str]:
    """
    Helper function to create a Daily.co room and generate an access token.
...
async def start_agent(request: Request):
    ...
    Creates a room, starts a bot instance, and redirects to the Daily.co room URL.

    Returns:
        RedirectResponse: Redirects to the Daily.co room URL
