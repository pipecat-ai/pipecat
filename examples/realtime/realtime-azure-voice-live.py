...
Remember, your responses should be short. Just one or two sentences, usually. Respond in English.""",
            session_properties=SessionProperties(
                ...
                # Any Azure text to speech voice, including HD and custom voices.
                voice=AzureStandardVoice(name="en-US-Ava:DragonHDLatestNeural"),
                # azure_semantic_vad weighs what was said as well as whether anyone
                # is speaking, so a mid-sentence pause doesn't end the turn. Pass
                # turn_detection=None to drive turns from transport VAD instead.
    ...
    # AzureVoiceLiveLLMService will convert this internally to messages that the
    # Voice Live WebSocket API can understand.
    context = LLMContext(
    ...
    # Subscribe to user turn lifecycle events. Voice Live emits its own
