- Added `PipelineWorker(processor_unusable_policy=...)`, deciding what the pipeline does when a processor reports an error that leaves it unable to do its job, such as a service whose API key was rejected.
