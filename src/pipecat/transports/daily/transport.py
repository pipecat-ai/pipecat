...
class DailyTransportClient(EventHandler):
    ...
    async def start_dialout(self, settings) -> Tuple[str, CallClientError]:
    ...
    async def stop_dialout(self, participant_id) -> CallClientError:
    ...
    async def send_dtmf(self, settings) -> CallClientError:
    ...
    async def sip_call_transfer(self, settings) -> CallClientError:
    ...
    async def sip_refer(self, settings) -> CallClientError:
    ...
    async def stop_recording(self, stream_id) -> CallClientError:
    ...
    async def start_transcription(self, settings) -> CallClientError:
    ...
    async def stop_transcription(self) -> CallClientError:
    ...
    async def remove_custom_audio_track(self, track_name: str) -> CallClientError:
    ...
    async def update_transcription(self, participants=None, instance_id=None) -> CallClientError:
    ...
    async def update_publishing(self, publishing_settings: Mapping[str, Any]) -> CallClientError:
...
class DailyTransport(BaseTransport):
    ...
    async def start_dialout(self, settings=None) -> Tuple[str, CallClientError]:
        """Start a dial-out call to a phone number.
    ...
    async def stop_recording(self, stream_id=None) -> CallClientError:
        """Stop recording the call.
    ...
    async def start_transcription(self, settings=None) -> CallClientError:
        """Start transcription for the call.
