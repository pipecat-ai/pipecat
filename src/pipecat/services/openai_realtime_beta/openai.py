...
class OpenAIRealtimeBetaLLMService(OpenAIRealtimeLLMService):
    """Deprecated alias for OpenAIRealtimeLLMService.
    ...
    def __init__(self, **kwargs):
        """Initialize the deprecated OpenAIRealtimeBetaLLMService.

        Args:
            **kwargs: All arguments passed to OpenAIRealtimeLLMService.
        """
