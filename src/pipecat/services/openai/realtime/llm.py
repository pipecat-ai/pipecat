    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            additional_headers: Extra WebSocket headers to include when connecting.
                Values here override any headers generated by ``use_codex_auth``.
            use_codex_auth: Add Codex CLI-compatible headers for ChatGPT OAuth
                access tokens supplied via ``api_key``. This is experimental and
                requires a compatible Realtime endpoint/model entitlement.
        ...
        self._additional_headers = _codex_realtime_headers(api_key) if use_codex_auth else {}
        if additional_headers:
            self._additional_headers.update(dict(additional_headers))
