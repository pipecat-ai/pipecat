...
class DeepgramTTSService(TTSService):
    ...
    .. deprecated:: 0.0.96
        This class is deprecated. Use `DeepgramWebsocketTTSService` instead for better performance
    ...
    def __init__(
        ...
        **kwargs,
        ...
        with warnings.catch_warnings():
            ...
            warnings.warn(
                "`DeepgramTTSService` is deprecated. Use `DeepgramWebsocketTTSService` instead for better performance and interruption handling.",
                DeprecationWarning,
                stacklevel=2,
            )
...
class DeepgramWebsocketTTSService(WebsocketTTSService):
