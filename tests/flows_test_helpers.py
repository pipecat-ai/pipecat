...
def make_mock_worker():
    ...
    Setting ``mock_worker.interrupted = True`` mirrors what an interruption does to a real
    ...
    async def queue_frame(frame):
        if mock_worker.interrupted and not isinstance(frame, UninterruptibleFrame):
            return
