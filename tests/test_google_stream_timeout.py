...
"""Tests for the streamed-response idle timeout in GoogleLLMService."""
...
async def _stream(generator, timeout=IDLE_TIMEOUT):
    ...
    """
    service = GoogleLLMService(api_key="test-key", stream_idle_timeout_secs=timeout)
...
def test_timeout_is_enabled_by_default():
