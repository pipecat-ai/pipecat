...
def _parse_config_dict(file_data: dict) -> ProjectConfig:
    """Simulate the merging logic from run_non_interactive_scaffold: map config dict keys
    to validate_and_build_config kwargs, exactly as the CLI does after loading JSON."""
