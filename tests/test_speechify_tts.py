...
# The nested shape the batch /v1/audio/speech endpoint returns for the same text.
BATCH_MARKS = {
    "type": "sentence",
    "start": 0,
    "end": 12,
...
class TestSpeechMarks:
    ...
    def test_batch_shaped_marks_are_flattened_to_words(self):
        """The nested sentence mark contributes its words, not itself."""
        assert word_times(BATCH_MARKS) == [("Hello", 0.0), ("world.", 0.469)]
